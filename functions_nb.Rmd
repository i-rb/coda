...
```{r}
xy_reg4(Y=m1, X=list(m2), Z=list(m5))
```


```{r}
ss = xy_reg(Y = m1, X = list(m2), Z=list(m5), c=TRUE)
```
...
I feel that this would works if xy_reg works. It is only a particular case of the xy reg. (IT DOES NOT WORK WELL)
