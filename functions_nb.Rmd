...
```{r}
m1 = rbind(c(0.25,0.75),c(0.5,0.5),c(0.9,0.1),c(0.33,0.64)) # 2 parts, n=4
m2 = rbind(c(0.1,0.4,0.5),c(0.3,0.3,0.4),c(0.9,0.05,0.05),c(0.1,0.7,0.2)) # 2 parts, n=4
m3 = matrix(c(23,1,32,12)) # 2 parts, n=4
```
...
### Adding variance of the parameters
...
Two ways of output: independent or dependent variable.
